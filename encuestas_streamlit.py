...
def crear_encuesta():
    ...
    if "tipos_preguntas" not in st.session_state:
        st.session_state.tipos_preguntas = ["Texto"] * 10  # Máximo 10 preguntas
    ...
    # Selector dinámico fuera del formulario para evitar envío accidental
    st.slider(
    ...
    # Edición dinámica de preguntas (fuera del formulario para evitar enter)
    ...
    # Botón de envío dentro del formulario (lo único que puede enviar)
    with st.form("form_guardar_encuesta", clear_on_submit=False):
        ...
        try:
            ...
            if len(response.data) > 0:
                ...
                with col2:
                    ...
                    st.markdown(f"[{enlace_resultados}]({enlace_resultados})")
